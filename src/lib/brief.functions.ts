...
function honeypotBrief(input: { businessName: string; location: string }): Brief {
  return {
    ...
    recommendation: "Create an account to keep watching your market every week.",
    why: "We'll watch your local market and keep the briefs coming — sign up to save your details.",
    sources: [],
    warnings: [],
