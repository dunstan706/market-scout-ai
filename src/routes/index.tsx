...
const PLANS = [
  {
    ...
    price: "$15",
    period: "/mo",
    blurb: "One business, on-demand scans, and the full picture in your inbox every Monday.",
    items: ["1 business", "On-demand market scans", "Weekly brief by email", "Prices, promotions & hours of up to 5 competitors"],
  ...
  },
  {
    ...
    price: "$50",
    period: "/mo",
    blurb: "Everything in Watch across up to 5 businesses, with deeper coverage and instant alerts.",
    items: ["Everything in Watch", "Up to 5 businesses", "Up to 15 competitors per business", "New openings & closures", "Actionable recommendations", "Same-day alerts when a rival cuts prices or your rating slips"],
    featured: true,
    cta: "Sign up to subscribe",
  },
  {
    ...
    period: "",
    blurb: "Unlimited businesses for multi-location owners planning their next branch.",
    items: ["Everything in Advise", "Unlimited businesses", "Neighbourhood development tracking", "Next-location recommendations"],
    cta: "Ask for a quote",
  },
];
